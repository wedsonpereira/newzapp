  ...
  return (
    <>
       <nav className='d-flex flex-column' style={{width:"100%", backgroundColor:'black',height:"15vh"}}>
          <div className='headercontent d-flex align-items-center justify-content-center w-100 ' style={{height:"64%"}}>
            <Button className='mb-2 mx-1' >
              <Link  to="/" className='p-0'><img src={logo} alt="" title='Home' className='p-0'/></Link>
            </Button>
            <h2 className='text-white'>NewzAPP</h2>
          </div>
          <div style={{height:"30%",borderTop:"1px solid red"}} className='d-flex justify-content-evenly'>
            ...
            <Link to="/Sci&tech"><Button style={{padding:"5px"}} className='text-light'>Science & Tech</Button></Link>
          </div>
        </nav>
